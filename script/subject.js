...
document.title = `${studentInfo.성명} ${studentInfo.평가회차}차 ${studentInfo[propName]}교수님 지도과목`;

const title = document.querySelector("#title");
title.innerHTML = `커뮤니케이션디자인전공</br>${studentInfo.평가연도}년도 졸업작품 최종`;
const subtitle = document.querySelector("#subtitle");
subtitle.innerHTML = `${studentInfo.성명} ${studentInfo.학번}</br>${studentInfo[propName]}교수님 지도과목`;
